...
%TODO(Jorge): Poner referencia a definicion.
%TODO(Jorge): Me confundo entre signal y behaviour, poner signal y
% poner distincion en la nota al pie.
%TODO(Marcos): Quizas sea mejor usar Senal en lugar de Comportamiento.
\begin{definicion}
...
%TODO(Marcos): Para que se presentan estas funciones? Poner un poco de texto antes.
% Se podrian poner pequenos ejemplos de aplicaciones, como tambien antes
% se podrian poner ejemplos de comportamientos y eventos.
