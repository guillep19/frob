...
\input{design/language_grammar.tex}
...
% TODO(Guille): Dado que ahora esta el sistema de tipos, aclarar en los
% lugares que sea necesario, que quedo fuera del alcance en la implementacion
% y se asume que quien escribe un programa, respeta el sistema.
