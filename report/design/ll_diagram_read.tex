...
\selectlanguage{english}
  ...
  \node[stack=5,yshift=2cm,xshift=4cm,align=center,
   ...
   \node [block] (s2) [yshift=3cm,xshift=1cm] {$\textit{Input}_{s_n}$};
 ...
 \begin{scope}[xshift=7cm,yshift=0cm,very thick,
  ...
  \node[stack=5,yshift=2cm,xshift=4cm,align=center,
   ...
   \node [comp]  (ca2) [xshift=1cm,yshift=1cm] {$\textit{S}_{id}$};
   \node [block] (s2) [above=of ca2]   {$\textit{Input}_{s_n}$} edge [->] (ca2);
